...
Edexml loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/Oefenweb/cakephp-edexml/tree/gh-pages)
...
Edexml tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test Edexml AllEdexml

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/Edexml
...
* [Bug tracker](https://github.com/Oefenweb/cakephp-edexml/issues)
